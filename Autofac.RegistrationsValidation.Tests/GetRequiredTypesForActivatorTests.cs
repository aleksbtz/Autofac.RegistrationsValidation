using Aleksbtz.Autofac.RegistrationsValidation.ActivatorsExtensions;
using Aleksbtz.Autofac.RegistrationsValidation.Models;
using Aleksbtz.Autofac.RegistrationsValidation.Tests.Infrastructure;
using Autofac;
...
namespace Aleksbtz.Autofac.RegistrationsValidation.Tests;
